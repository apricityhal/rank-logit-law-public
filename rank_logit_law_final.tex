...
improving the clarity of the manuscript, and preparing it for submission.}}
...
\citet{lee2026compress} studies row-centered logits as well under the name
``energy field,'' and measures that the models tested reach \(90\%\) of the
field's variance within 2--11 singular components. This suggests that a version of our result might
